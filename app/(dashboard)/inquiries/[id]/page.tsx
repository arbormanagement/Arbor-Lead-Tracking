            ...
            <div className="card-body">
              ...
              {!attributed && (
                <p className="muted" style={{ fontSize: 12, margin: "12px 0 0" }}>
                  No source could be determined for this inquiry — no click ID, UTM, referrer, or tracking-number match.
                </p>
              )}
              {touches.length > 1 && (
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="def-list">
                ...
                <Def label="Disposition reason" title="Why this inquiry was dispositioned the way it was">
